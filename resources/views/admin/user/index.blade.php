                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($user as $ser)
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $ser->email }}</td>
                                                <td class="text-center">{{ $ser->role }}</td>
                                                {{-- <td>
                                                    <form method="POST" action="{{ route('product.destroy', $ser->id) }}">
                                                        @csrf
                                                        @method('DELETE')
                                                ...
                                                <td>
                                                    <a class="btn btn-block bg-gradient-primary" href="{{ route('product.show',$ser->id) }}">Detail</a>
                                                </td>
                                                <td>
                                                    <a class="btn btn-block bg-gradient-success" href="{{ url('product-edit',$ser->id) }}">Edit</a>
                                                </td> --}}
                                            </tr>
                                        @endforeach
