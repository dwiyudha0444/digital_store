                        ...
                        <div class="card">
                            <div class="card-header mt-3">
                                <div class="row">
                                    ...
                                    <div class="col-12"> <!-- Adjusted the column size to take 3 columns -->
                                        <section class="content">
                                            <div class="container-fluid">
                                                <div class="row">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($order as $or)
                                            <tr>
                                                ...
                                                <td class="text-center">{{ $or->nama_product }}</td>
                                                <td class="text-center">{{ $or->nama }}</td>
                                                <td class="text-center">{{ $or->no_wa }}</td>
                                                <td class="text-center">{{ $or->qty }}</td>
                                                <td class="text-center">{{ $or->harga }}</td>
                                                <td class="text-center">{{ $or->total_harga }}</td>
                                                <td class="text-center">{{ $or->status }}</td>
                                                {{-- <td>
                                                    <form method="POST" action="{{ route('product.destroy', $or->id) }}">
                                                        @csrf
                                                        @method('DELETE')
                                                ...
                                                <td>
                                                    <a class="btn btn-block bg-gradient-primary" href="{{ route('product.show',$or->id) }}">Detail</a>
                                                </td>
                                                <td>
                                                    <a class="btn btn-block bg-gradient-success" href="{{ url('product-edit',$or->id) }}">Edit</a>
                                                </td> --}}
                                            </tr>
                                        @endforeach
